...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0Get-AutonomousHeartbeatStatus.ps1" -RhythmNextActionJsonPath "%RHYTHM_NEXT_ACTION_PATH%" -StaticPreflightJsonPath "%STATIC_PREFLIGHT_PATH%" %*
exit /b %ERRORLEVEL%
