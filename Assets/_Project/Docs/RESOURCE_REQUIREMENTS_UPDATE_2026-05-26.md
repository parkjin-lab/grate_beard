...
- Static preflight now checks that the automation mode policy table and all five `automationMode` values remain in the autonomous operations playbook.
