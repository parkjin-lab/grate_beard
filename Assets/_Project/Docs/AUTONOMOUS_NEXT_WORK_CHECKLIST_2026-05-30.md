...
| Player wall-spawn recovery | Player can still appear inside existing scene blockers, not only generated map blockers | Defaulted player spawn safety to all blocker colliders and added generated-cell-center fallback recovery |
