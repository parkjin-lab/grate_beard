...
| Rhythm test evidence | Manual rhythm tests needed an easy way to preserve current telemetry | Added `Write Rhythm Snapshot` to DebugOverlay, saving phase/pressure/audio/player state under `Logs/RhythmValidation/` |
