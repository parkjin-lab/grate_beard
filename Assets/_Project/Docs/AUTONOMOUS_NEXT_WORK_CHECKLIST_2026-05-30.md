...
- Add small guardrails that catch missing rhythm phases, missing stinger assignments, spawn safety regressions, invalid state transitions, and vendor import regressions. `[in progress: validation, spawn safety, rhythm state, and vendor ignore preflight checks added]`
