...
- Read `StaticPreflightGeneratedAt`, `StaticPreflightDurationMilliseconds`, and `StaticPreflightDurationWarning` from safe-task JSON or heartbeat Markdown before using static preflight evidence in a claim.
