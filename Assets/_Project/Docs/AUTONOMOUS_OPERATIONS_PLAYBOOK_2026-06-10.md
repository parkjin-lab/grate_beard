...
- Read `StaticPreflightWarnCount`, `StaticPreflightHasWarnings`, and `StaticPreflightWarningSummary` from safe-task JSON or heartbeat Markdown before using stale WARN evidence in a claim.
