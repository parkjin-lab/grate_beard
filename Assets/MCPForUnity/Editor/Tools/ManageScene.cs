    ...
    public static class ManageScene
    {
        ...
        private static object CaptureScreenshot(string fileName, int? superSize)
        {
            try
            {
                ...
                bool hasCameraFallback = Camera.main != null || FindAllCameras().Length > 0;
        ...
        private static Camera[] FindAllCameras()
        {
#if UNITY_2023_1_OR_NEWER
            return UnityEngine.Object.FindObjectsByType<Camera>(FindObjectsSortMode.None);
#else
            return UnityEngine.Object.FindObjectsOfType<Camera>();
#endif
        }

        private static UnityEngine.Object ResolveEditorObject(int instanceId)
        {
