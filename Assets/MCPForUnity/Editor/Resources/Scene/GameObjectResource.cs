...
namespace MCPForUnity.Editor.Resources.Scene
{
    ...
    public static class GameObjectResource
    {
        public static object HandleCommand(JObject @params)
        {
            ...
            try
            {
                var go = EditorObjectResolver.Resolve(instanceID.Value) as GameObject;
                if (go == null)
                {
    ...
    public static class GameObjectComponentsResource
    {
        public static object HandleCommand(JObject @params)
        {
            ...
            try
            {
                var go = EditorObjectResolver.Resolve(instanceID) as GameObject;
                if (go == null)
                {
                    return new ErrorResponse($"GameObject with instance ID {instanceID} not found.");
                }
    ...
    internal static class EditorObjectResolver
    {
        public static UnityEngine.Object Resolve(int instanceId)
        {
